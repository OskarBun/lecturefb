define(
	...
	function (jquery,ko) {
        ...
        Connection.prototype.toggle_connection = function(){
		...
		Connection.prototype.send = function(action, args, callback, target){
			// console.log(message);
			this.error(null);
			var request_id = this._next_request_id_(callback,target);
			if(this.is_connected() === true){
                this._ws_.send(ko.toJSON({
                    "action": action,
                    "args": args,
